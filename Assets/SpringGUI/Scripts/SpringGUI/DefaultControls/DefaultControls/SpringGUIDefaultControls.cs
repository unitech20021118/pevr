...
namespace SpringGUI
{
    public static class SpringGUIDefaultControls
    {
        ...
        public static GameObject CreateColorPicker( Resources resources )
        {
            ...
            var pmButtonTarget = CreateUIObject("TargetGameObject" , pmButton.transform , new Vector2(12 , 9));
            ...
            var cmButtonTarget = CreateUIObject("TargetGameObject" , cmButton.transform , new Vector2(9 , 9));
