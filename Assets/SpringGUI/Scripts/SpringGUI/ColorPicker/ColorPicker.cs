...
/*=========================================
* Author: springDong
* Description: SpringGUI.ColorPicker component.
* 1.Color picker is not support the HSV color model
* 2.It is easy to used. Lisen onPicker ,you will get color value.
==========================================*/
...
namespace SpringGUI
{
    public class ColorPicker : UIBehaviour
    {
        ...
        private void resetColorPicker()
        {
            ...
            if (GetComponent<ColorPickerUI>().image != null)
            {
                GetComponent<ColorPickerUI>().image.color = Color;
            }
            SetHexByColor();
