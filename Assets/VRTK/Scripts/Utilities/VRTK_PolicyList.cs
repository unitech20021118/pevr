...
namespace VRTK
{
    ...
    ///
    /// Then in the component that has a Policy List paramter (e.g. BasicTeleporter has `TargetGameObject List Policy`) simply select the list that has been created and defined.
    /// </remarks>
