...
namespace VRTK
{
    ...
    public class VRTK_InteractTouch : MonoBehaviour
    {
        ...
        /// 用于存放手柄当前接触到的物体的列表
        /// </summary>
        static List<GameObject>touchedGameObjects = new List<GameObject>();
        /// <summary>
        /// 手柄停止接触的物体
        /// </summary>
        static GameObject unTouchedGameobject;
        ...
        public List<GameObject> GetTouchedGameObjects()
        {
            return touchedGameObjects;
        }

        public GameObject GetUnTouchedGameObject()
        {
            return unTouchedGameobject;
        }
        /// <summary>
        ...
        protected virtual void OnTriggerEnter(Collider collider)
        {
            ...
            //added by kuai
            touchedGameObjects.Add(collider.gameObject);
        }
        ...
        protected virtual void OnTriggerExit(Collider collider)
        {
            ...
            {
                for (int i = 0; i < touchedGameObjects.Count; i++)
                {
                    if (touchedGameObjects[i]==collider.gameObject)
                    {
                        touchedGameObjects.Remove(touchedGameObjects[i]);
                        
                    }
                }   
            }
            unTouchedGameobject = collider.gameObject;
        }
